...
import myfirstmod.BasicMod;
import myfirstmod.util.CardStats;
import myfirstmod.util.TriFunction;
...
import static myfirstmod.util.GeneralUtils.removePrefix;
import static myfirstmod.util.TextureLoader.getCardTextureString;
